...
class KNearestNeighbors(Classifier):
  def __init__(self, k, dist, unitw, train_file, test_file):
    """The K Nearest Neighbors classifier
    
    Args:
      k: Number of nearest neighbors to consider for classification.
      dist: distance function to calculate closeness of neighbors.
...
class KMeans(Classifier):
  ...
  def __init__(self, dist, data_file, centroids):
    self.dist = dist
